...
#These lines are for a DLL issues I'm having on my system.
#Remove these two lines when you are running it on your system if there is any error.
...
def main() -> None:
    ...
    if use_sample:
        # Use the sample PDF
        sample_path = r"C:\Users\USER\Projects\RAG\TalkToPDF\data\pdf\metagpt.pdf"
